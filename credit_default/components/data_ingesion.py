...
from credit_default.constant.training_pipeline import SCHEMA_DROP_COLS, SCHEMA_FILE_PATH
...
from credit_default.constant.training_pipeline import SCHEMA_FILE_PATH,SCHEMA_TARGET_COL,FILE_NAME
