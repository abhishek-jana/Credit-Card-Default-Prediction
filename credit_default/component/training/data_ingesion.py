...
from credit_default.entity.metadata_entity import DataIngestionMetadata
from credit_default.exception import CreditException
from credit_default.logging import logger
from datetime import datetime
from credit_default.constant.environment.variable_key import KAGGLE_DATA_API_KEY,KAGGLE_DATA_USERNAME,KAGGLE_DIR
...
class DataIngestion:
    ...
    def download_data(self):
        try:
            # logger.info(f"Starting download operation: {download_data}")
            # download_dir = os.path.join(self.data_ingestion_config.data_ingestion_dir, "downloaded_files")
            ...
            # destination = self.data_ingestion_config.feature_store_dir #download_data.downloaded_dir
